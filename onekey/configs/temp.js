export default {
  ...
  maliciousThreshold: 0, // 初始恶意交易者卖出阈值，卖出次数超过该值则被判定为恶意交易者, 等于0时，不受控制
  rewardThreshold: 0, // 初始分红剥夺卖出次数限制, 等于0时，不受控制
  maxSell: 0, // 最大卖出值，单位：1, 等于0时，不受控制
  maxBuy: 0, // 最大买入值, 单位：亿, 等于0时，不受控制
